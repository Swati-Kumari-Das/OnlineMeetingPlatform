...
let getUserMediaSuccess =(stream)=>{
    ...
    for(let id in connections){
        ...
        connections[id].createOffer().then((description)=>{
            connections[id].setocalDescription(description)
            .then(()=>{
...
let silence=()=>{
    ...
    let dst=oscillator.connect(ctx.createMediaSteamDestination());
    ...
    socketRef.current.on("connect",()=>{
        ...
        socketRef.current.on("user-joined",(id,clients)=>{
            clients.forEach((socketListId)=>{
                ...
                connections[socketListId].onicecandidate=(event)=>{  //protocol make connection b/w two client
